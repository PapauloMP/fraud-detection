...
AI_TEXTS_FILE = os.path.join(PROJECT_ROOT, "inputs", "datasets", "ai_essays.csv")
...
MODEL = MODELS[4]
OUTPUT_FILE = os.path.join(DATASET_DIR, f"copy_typed_{normalize_model_name(MODEL)}.csv")
...
def main():
    ...
    df = pd.read_csv(AI_TEXTS_FILE).iloc[0:1]
